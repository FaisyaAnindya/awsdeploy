...
class Petugas {
    ...
    function create() {
        ...
        $allowedRoles = ['admin', 'staf']; // Gantilah dengan nilai-nilai ENUM yang sesuai
        $this->Role = in_array($this->Role, $allowedRoles) ? $this->Role : null;
        ...
        $result->bindParam(":Role", $this->Role, PDO::PARAM_STR); // PDO::PARAM_STR digunakan karena ENUM biasanya berupa string
